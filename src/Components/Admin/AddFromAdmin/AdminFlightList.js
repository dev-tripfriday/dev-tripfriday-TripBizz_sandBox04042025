...
import "../../Flights/FlightList/FlightList.css"
...
function AdminFlightList(props) {
    ...
    const intArrHandleTime1Click = async (time) => {
        const startDate = new Date();
        const endDate = new Date();
        if (time === "morning") {
          startDate.setHours(0);
      ...
      const intArrHandleTime2Click = async (time) => {
        const startDate = new Date();
        const endDate = new Date();
      ...
      const intDepHandleTime1Click = async (time) => {
        const startDate = new Date();
        const endDate = new Date();
        if (time === "morning") {
          startDate.setHours(0);
      ...
      const intDepHandleTime2Click = async (time) => {
        const startDate = new Date();
        const endDate = new Date();
        if (time === "morning") {
          startDate.setHours(0);
